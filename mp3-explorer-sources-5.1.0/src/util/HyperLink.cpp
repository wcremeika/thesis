...
void CHyperLink::OnClicked()
{
	...
	pParent->SendMessage( WM_LINK_ACTION, m_nAction, 0 );
...
void CHyperLink::Init(CString strLink, int nAction)
{
	SetWindowText( strLink );
	SetURL( strLink );
	m_nAction = nAction;
